...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // SomeLiveRadioPlayer config
        SomeLiveRadioPlayer.shared.isAutoPlay = true
        SomeLiveRadioPlayer.shared.enableArtwork = true
        SomeLiveRadioPlayer.shared.artworkSize = 600
    ...
    override func remoteControlReceived(with event: UIEvent?) {
        ...
        case .remoteControlPlay:
            SomeLiveRadioPlayer.shared.play()
        case .remoteControlPause:
            SomeLiveRadioPlayer.shared.pause()
        case .remoteControlTogglePlayPause:
            SomeLiveRadioPlayer.shared.togglePlaying()
