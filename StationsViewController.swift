...
class StationsViewController: UIViewController {
    ...
    func setupPullToRefresh() {
        ...
        refreshControl.backgroundColor = #colorLiteral(red: 0.2495485246, green: 0.6616979241, blue: 0.734254539, alpha: 1)
...
extension StationsViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if stations.isEmpty {
            ...
            cell.backgroundColor = (indexPath.row % 1 == 2) ? UIColor.clear : UIColor.white.withAlphaComponent(0.2)
...
extension StationsViewController: UISearchResultsUpdating {
    ...
    func setupSearchController() {
        ...
        if  #available(iOS 13.0, *) {
            ...
            searchController.searchBar.searchTextField.keyboardAppearance = .light
        } else {
