...
class NowPlayingViewController: UIViewController {
    ...
    let radioPlayer = SomeLiveRadioPlayer.shared
    ...
    func setupAirPlayButton() {
        ...
        if #available(iOS 13.0, *) {
            ...
            airPlayButton.tintColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
    ...
    func playbackStateDidChange(_ playbackState: SomeLiveRadioPlaybackState, animate: Bool) {
    ...
    func playerStateDidChange(_ state: SomeLiveRadioPlayerState, animate: Bool) {
    ...
    @IBAction func shareButtonPressed(_ sender: UIButton) {
        ...
        let radioShoutout = "I'm listening to \(currentStation.name), check it out!"
